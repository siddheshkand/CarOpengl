...
/*
 * opengl Init explained
 * opengl glutReshapeFunc explained
 * opengl glutKeyboardFunc explained
 * opengl glutVisibilityFunc explained
 * opengl glutDisplayFunc explained
 * opengl glutMainLoop explained
 * stackoverflow.com
 * */